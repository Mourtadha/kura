...
public class BluetoothAdapterImpl implements BluetoothAdapter {
    ...
    //
    // --------------------------------------------------------------------
    public static String getInterfaceName(String path) {
        String[] interfaceName = path.split("/");
        return interfaceName[interfaceName.length];
    }
    ...
    public void startBeaconAdvertising() {
        ...
        logger.debug("Start Advertising : hcitool -i " + this.name + " cmd " + OGF_CONTROLLER_CMD + " "
        ...
        BluetoothUtil.hcitoolCmd(this.name, cmd, bbl);
    ...
    public void stopBeaconAdvertising() {
        ...
        logger.debug("Stop Advertising : hcitool -i " + this.name + " cmd " + OGF_CONTROLLER_CMD + " "
    ...
    public void setBeaconAdvertisingInterval(Integer min, Integer max) {
        ...
        logger.debug("Set Advertising Parameters : hcitool -i " + this.name + " cmd " + OGF_CONTROLLER_CMD + " "
    ...
    public void setBeaconAdvertisingData(String uuid, Integer major, Integer minor, String companyCode, Integer txPower,
        ...
        logger.debug("Set Advertising Data : hcitool -i " + this.name + "cmd " + OGF_CONTROLLER_CMD + " "
    ...
    public void ExecuteCmd(String ogf, String ocf, String parameter) {
        ...
        logger.info("Execute custom command : hcitool -i " + this.name + "cmd " + ogf + " " + ocf + " "
