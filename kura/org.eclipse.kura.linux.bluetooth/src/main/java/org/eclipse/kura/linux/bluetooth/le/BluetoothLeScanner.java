...
public class BluetoothLeScanner implements BluetoothProcessListener, BTSnoopListener {
    ...
    public void killScan(tinyb.BluetoothAdapter adapter) {
        ...
        // }
        List<tinyb.BluetoothDevice> list = adapter.getDevices();
        this.listener.onScanResults(convertToBluetoothDevices(list));
